...
#define STRING_CONFIG_H_AUTHOR "(axtox)" // Who made the changes.
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 600, 600, 100, 3000 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 1200, 1200, 200, 6000 } // ...or, set your own edit limits
#endif
...
#define XY_PROBE_FEEDRATE (200*60)  //F12000
...
// Set to false for dual-drive (BMG-style) extruders which run in reverse compared to stock.
#define INVERT_E0_DIR true 
#define INVERT_E1_DIR true   // match E0 direction for dual-drive on second extruder output
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 30, 40, 40, 30 }
 ...
 */
#define Z_PROBE_END_SCRIPT "G27 P2"
